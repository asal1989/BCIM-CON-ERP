...
const EmpMasterReportsPage  = lazy(() => import('./pages/hr-admin/EmployeeMasterReportsPage'));
...
// Phase 2 — Employee Information
const PositionHistoryPage    = lazy(() => import('./pages/hr-admin/PositionHistoryPage'));
const SeparationPage         = lazy(() => import('./pages/hr-admin/SeparationPage'));
const EmployeeDocumentsPage  = lazy(() => import('./pages/hr-admin/EmployeeDocumentsPage'));
// Phase 3 — Employee Admin
const GenerateLetterPage     = lazy(() => import('./pages/hr-admin/GenerateLetterPage'));
const BulkPhotoUploadPage    = lazy(() => import('./pages/hr-admin/BulkPhotoUploadPage'));
const BulkDocumentUploadPage = lazy(() => import('./pages/hr-admin/BulkDocumentUploadPage'));
const BulletinBoardPage      = lazy(() => import('./pages/hr-admin/BulletinBoardPage'));
const MassCommunicationPage  = lazy(() => import('./pages/hr-admin/MassCommunicationPage'));
const IdentityVerificationPage = lazy(() => import('./pages/hr-admin/IdentityVerificationPage'));
const ContractDetailsPage    = lazy(() => import('./pages/hr-admin/ContractDetailsPage'));
const DataDrivePage          = lazy(() => import('./pages/hr-admin/DataDrivePage'));
// Phase 4 — Employee Setup
const LetterTemplatePage     = lazy(() => import('./pages/hr-admin/LetterTemplatePage'));
          ...
          <Suspense fallback={<LoadingScreen />}>
            <Routes>
              ...
              <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
                ...
                <Route path="hr-admin/reports/employee-master" element={<RequireModule module="HR & Admin"><EmpMasterReportsPage /></RequireModule>} />
                ...
                {/* HR & Admin — Phase 2: Employee Information */}
                <Route path="hr-admin/position-history" element={<RequireModule module="HR & Admin"><PositionHistoryPage /></RequireModule>} />
                <Route path="hr-admin/separation" element={<RequireModule module="HR & Admin"><SeparationPage /></RequireModule>} />
                <Route path="hr-admin/employee-documents" element={<RequireModule module="HR & Admin"><EmployeeDocumentsPage /></RequireModule>} />

                {/* HR & Admin — Phase 3: Employee Admin */}
                <Route path="hr-admin/generate-letter" element={<RequireModule module="HR & Admin"><GenerateLetterPage /></RequireModule>} />
                <Route path="hr-admin/bulk-photo-upload" element={<RequireModule module="HR & Admin"><BulkPhotoUploadPage /></RequireModule>} />
                <Route path="hr-admin/bulk-document-upload" element={<RequireModule module="HR & Admin"><BulkDocumentUploadPage /></RequireModule>} />
                <Route path="hr-admin/bulletin-board" element={<RequireModule module="HR & Admin"><BulletinBoardPage /></RequireModule>} />
                <Route path="hr-admin/mass-communication" element={<RequireModule module="HR & Admin"><MassCommunicationPage /></RequireModule>} />
                <Route path="hr-admin/identity-verification" element={<RequireModule module="HR & Admin"><IdentityVerificationPage /></RequireModule>} />
                <Route path="hr-admin/contracts" element={<RequireModule module="HR & Admin"><ContractDetailsPage /></RequireModule>} />
                <Route path="hr-admin/data-drive" element={<RequireModule module="HR & Admin"><DataDrivePage /></RequireModule>} />

                {/* HR & Admin — Phase 4: Employee Setup */}
                <Route path="hr-admin/letter-templates" element={<RequireModule module="HR & Admin"><LetterTemplatePage /></RequireModule>} />
