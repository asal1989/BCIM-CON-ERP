...
const NMR_SKILLED_TRADES = ['Mason','Carpenter','Barbender','Scaffolder','Plumber','Electrician','Engineer','Supervisor','Painter'];

// Matches each WO line item to a skill-wise attendance group (same heuristic
// used for both NMR wage totals and the bill/MB entries raised from it, so
// the two always agree), and prices each match at the WO's own contracted
...
router.post('/nmr', authorize(...PLANNER), async (req, res) => {
  try {
    ...
    // worker payroll rate (sc_workers.daily_rate / sc_attendance.wage_amount),
    // which is separate, informational data about how the subcontractor pays
    // its own workers.
    const woItemsForRate = await query(`SELECT * FROM sc_wo_items WHERE wo_id=$1 ORDER BY sequence_no`, [wo_id]);
    ...
    // Any skill with no matching WO item falls back to actual attendance wages
    // (sc_attendance.wage_amount/overtime_amount) so nothing goes unpriced.
    if (unmatched.length) {
      for (const a of attendance.rows) {
        const skill = skillMap[a.worker_id] || 'Unskilled';
  ...
  try {
    ...
    const nmrBillResult = await withTransaction(async (client) => {
      ...
      if (woItems.length > 0 && skillGroups.length > 0) {
        let seq = 1;
        // Priced at the WO's own contracted rate per item — same matching used
        // for the NMR's own wage total, so the bill always agrees with it.
        const { matches, unmatched } = matchWOItemsToSkills(woItems, skillGroups);

        for (const m of matches) {
          const { item, skills: fresh, netQty, rate: effectiveRate } = m;
        ...
        // priced from actual attendance wages since there's no contracted
        // rate to use.
...
// ── One-time: seed the 332 subcontractor-employed workers from "P3 Active
// workers list" / "Lanco Active workers list" into sc_workers, so the SC
// Labour module reflects actual site headcount instead of just the 44
// direct-BCIM staff already seeded via hr-import.routes.js. 13 of the 18
// distinct contractor names on these sheets had no Subcontractor Master
// record at all — created here with just the name (sc_code auto-assigned,
// contractor_type inferred from whether the name reads as a person or a
// firm); everything else (GST, PAN, phone, trade type) is left for
// Procurement/QS to fill in later, same as any freshly onboarded vendor.
const SC_WORKERS_2026_08 = [{"emp_id":"18500022","name":"Chanaarik Bhuiyan","designation":"Mason-Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500026","name":"Dinesh Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500047","name":"Binod Chaudhary","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500062","name":"Umesh Korwa","designation":"Mason-Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500067","name":"Anil Korwa","designation":"Mason-Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500156","name":"Pitambar Korwa","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500178","name":"Ramnath Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500209","name":"Suresh Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500235","name":"Ravindra Korwa","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500237","name":"Meghnath Yadav","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500251","name":"Pachchu Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500255","name":"Shankar Korwa","designation":"Supervisor","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500258","name":"Rabindra Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500260","name":"Prashant Kumar","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500261","name":"Anil Korwa","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500276","name":"Babalu Malar","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500278","name":"Muklesh Korwa","designation":"Mason-Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500279","name":"Munesh Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500288","name":"Ramun Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500289","name":"Pramod Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500294","name":"Rajeev Kumar","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500298","name":"Sudhir Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500305","name":"Satendra Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500308","name":"Mukul Korva","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500312","name":"Jawahir Korwa","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500318","name":"Ajit Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500319","name":"Santosh Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500320","name":"Amrika Korwa","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500321","name":"Suraj Mal Kumar","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500322","name":"Binesh Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500323","name":"Nirmal Korva","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500325","name":"Sanoj Korwa","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500326","name":"Bifan Korwa","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500330","name":"Pappu Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500331","name":"Bikendra Paswan","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500332","name":"Vigan Korwa","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500333","name":"Upendra Korwa","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500334","name":"Rajesh Korwa","designation":"Mason","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500292","name":"Rakesh Korwa","designation":"Mason-Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500335","name":"Mandip Singh","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500336","name":"Mukesh Singh","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"18500337","name":"Sonu Bhuiyan","designation":"Helper","con_name":"Dayashankar","project":"Tech-P3"},{"emp_id":"22500013","name":"Musagul","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500023","name":"Md Jisan Ali","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500029","name":"Biplab Sarkar","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500121","name":"Mithun Mandal","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500158","name":"Aul hassan","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500175","name":"Md Rajib Sekh","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500176","name":"Nayim Ali","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500234","name":"Eshanur Ali","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500268","name":"Md Boni Amin","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500269","name":"Hawk Mujraul","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500271","name":"Meghnath Sahni","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500299","name":"Emam Hasan","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500302","name":"Zalil Sekh","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500310","name":"Tinku Mandal","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500325","name":"Nur Islam","designation":"Camp Cleaner","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500326","name":"Abdul Salam","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500327","name":"Pradip Rabi Das","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500328","name":"Bapi Mandal","designation":"Supervisor","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500332","name":"Asanur Ali","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500333","name":"Sayful Ali","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500337","name":"Md Ziaul Ali","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500340","name":"Namu Kisku","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500346","name":"Jiten Mallik","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500348","name":"Minarul Islam","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500350","name":"Rabiul Haque","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500351","name":"Nuriman","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500353","name":"Ganesh Pahari","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500354","name":"Abhijit Das","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500355","name":"Suranjan Sha","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500356","name":"Nur Alam","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500357","name":"Sakib Ali","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500050","name":"Balai Tudu","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500177","name":"Sushanto Hemram","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500358","name":"Ajay Saw","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500359","name":"Bapi Barman","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500361","name":"Prasenjit Murmu","designation":"Mason","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500243","name":"Rana Pandey","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500160","name":"Khetu Sarkar","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"22500290","name":"Rajda Murmu","designation":"Helper","con_name":"M R R Enterprises","project":"Tech-P3"},{"emp_id":"31100002","name":"Panchanan Karmakar","designation":"Helper","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100003","name":"Sachin Karmakar","designation":"Helper","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100004","name":"Pintu Mandal","designation":"Helper","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100006","name":"Thomas Hembrom","designation":"Helper","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100007","name":"Rajib Karmakar","designation":"Supervisor","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100009","name":"Munsur Ansari","designation":"Mason","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100010","name":"Emajuddin Ansari","designation":"Mason","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100012","name":"Ajoy Ghosh","designation":"Mason","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100013","name":"Dipak Pramanik","designation":"Helper","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100014","name":"Rajen Soren","designation":"Helper","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100015","name":"Badal Roy","designation":"Helper","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100016","name":"Raja Tudu","designation":"Mason","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100017","name":"Nithur Roy","designation":"Mason","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100018","name":"Banamali Barman","designation":"Mason","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"31100019","name":"Bijay Saren","designation":"Helper","con_name":"AVNR","project":"Tech-P3"},{"emp_id":"20401313","name":"Md Islam","designation":"Supervisor","con_name":"Gayatree","project":"Tech-P3"},{"emp_id":"20401327","name":"Safique Alam","designation":"Carpenter","con_name":"Gayatree","project":"Tech-P3"},{"emp_id":"20401329","name":"Md Ainal","designation":"Carpenter","con_name":"Gayatree","project":"Tech-P3"},{"emp_id":"20401330","name":"Aktar Ali","designation":"Carpenter","con_name":"Gayatree","project":"Tech-P3"},{"emp_id":"20401331","name":"Shamsad Hussain","designation":"Carpenter","con_name":"Gayatree","project":"Tech-P3"},{"emp_id":"20401332","name":"Fahad","designation":"Carpenter","con_name":"Gayatree","project":"Tech-P3"},{"emp_id":"20401333","name":"Abdul Basir","designation":"Carpenter","con_name":"Gayatree","project":"Tech-P3"},{"emp_id":"20401338","name":"Juber Alam","designation":"Carpenter Helper","con_name":"Gayatree","project":"Tech-P3"},{"emp_id":"20401340","name":"Najar Ali","designation":"Carpenter","con_name":"Gayatree","project":"Tech-P3"},{"emp_id":"20401349","name":"Saud Alam","designation":"Carpenter Helper","con_name":"Gayatree","project":"Tech-P3"},{"emp_id":"16100027","name":"Pappu Das","designation":"Mason","con_name":"MPIL","project":"Tech-P3"},{"emp_id":"16100046","name":"Ganesh   Das","designation":"Mason","con_name":"MPIL","project":"Tech-P3"},{"emp_id":"16100056","name":"Manish Kumar","designation":"Mason","con_name":"MPIL","project":"Tech-P3"},{"emp_id":"16100068","name":"Ramesh Kumar","designation":"Mason","con_name":"MPIL","project":"Tech-P3"},{"emp_id":"16100073","name":"Rahul Kumar","designation":"Mason","con_name":"MPIL","project":"Tech-P3"},{"emp_id":"16100074","name":"Pawan Kumar","designation":"Mason","con_name":"MPIL","project":"Tech-P3"},{"emp_id":"16100075","name":"Rajendra Das","designation":"Mason","con_name":"MPIL","project":"Tech-P3"},{"emp_id":"16100076","name":"Ashok Kumar","designation":"Mason","con_name":"MPIL","project":"Tech-P3"},{"emp_id":"18200014","name":"Mafijul Hoque","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200057","name":"Asim Aktar","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200118","name":"Bhadur Rahaman","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200121","name":"Tarikul","designation":"Mason Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200143","name":"Md Alam","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200150","name":"Abu Taher","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200151","name":"Akramul Hossain","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200152","name":"Mohammad Hatemul Islam","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200154","name":"Aktarul Hoque","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200155","name":"Serajul Hoque","designation":"Supervisor","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200156","name":"Habibur Rahaman","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200157","name":"Rabbul Haque","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200161","name":"Abdul Rahaman","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200171","name":"Sariful Haque","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200182","name":"Makim Ali","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200225","name":"Habibur Rahaman","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200239","name":"Mahammad Ali","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200250","name":"Ajabul Rahaman","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200251","name":"Arif","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200252","name":"Faruque Azam","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200255","name":"Sahmad Alam","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200258","name":"Alamgir Hoque","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200269","name":"Sadikul Islam","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200270","name":"Rakib","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200282","name":"Alimgir","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200286","name":"Sariful Islam","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200292","name":"Nasir Ali","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200293","name":"Md Israil","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200296","name":"Sajirul Hoque","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200317","name":"Imran Hossain","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200320","name":"Bishnu Lohar","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200321","name":"Bablu Turi","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200323","name":"Bimal Turi","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200327","name":"Ramchandra Mandal","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200329","name":"Maheshwar Mondal","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200330","name":"Nirmal Turi","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200331","name":"Deb Lal Turi","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200333","name":"Goutam Mandal","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200335","name":"Jitu Mandal","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200336","name":"Mijanur Rahaman","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200337","name":"Sarif Akhter","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200338","name":"Saidul Rahaman","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200339","name":"Md Amjad Ali","designation":"Mason","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"18200340","name":"Sarafat","designation":"Helper","con_name":"Masidur Rahaman","project":"Tech-P3"},{"emp_id":"20100085","name":"Muzahir","designation":"Mason","con_name":"C S Water Proofing","project":"Tech-P3"},{"emp_id":"20100087","name":"Awes Alam","designation":"Helper","con_name":"C S Water Proofing","project":"Tech-P3"},{"emp_id":"20100088","name":"Gul Mohammad","designation":"Helper","con_name":"C S Water Proofing","project":"Tech-P3"},{"emp_id":"20100094","name":"Naushad Alam","designation":"Helper","con_name":"C S Water Proofing","project":"Tech-P3"},{"emp_id":"20100097","name":"Md Kaunain Raza","designation":"Helper","con_name":"C S Water Proofing","project":"Tech-P3"},{"emp_id":"20100098","name":"Munajir Alam","designation":"Helper","con_name":"C S Water Proofing","project":"Tech-P3"},{"emp_id":"20100100","name":"Imtiyaj Babu","designation":"Helper","con_name":"C S Water Proofing","project":"Tech-P3"},{"emp_id":"23500003","name":"Saheb Molla","designation":"Helper","con_name":"Rukmina Khatoon","project":"Tech-P3"},{"emp_id":"23500013","name":"Sahin Reja Sk","designation":"Helper","con_name":"Rukmina Khatoon","project":"Tech-P3"},{"emp_id":"23500023","name":"Prasenjit Let","designation":"Helper","con_name":"Rukmina Khatoon","project":"Tech-P3"},{"emp_id":"30800002","name":"Rubel Mondal","designation":"Pipe Fitter","con_name":"Saheb Biswas","project":"Tech-P3"},{"emp_id":"30800003","name":"Manirul Sk","designation":"Pipe Fitter","con_name":"Saheb Biswas","project":"Tech-P3"},{"emp_id":"30800004","name":"Rasidul Sk","designation":"Pipe Fitter","con_name":"Saheb Biswas","project":"Tech-P3"},{"emp_id":"30800008","name":"Ashik Sk","designation":"Helper","con_name":"Saheb Biswas","project":"Tech-P3"},{"emp_id":"30800014","name":"Angur Sk","designation":"Operator","con_name":"Saheb Biswas","project":"Tech-P3"},{"emp_id":"30800015","name":"Firoj Mandal","designation":"Pipe Fitter","con_name":"Saheb Biswas","project":"Tech-P3"},{"emp_id":"30800016","name":"Najibul Sk","designation":"Operator","con_name":"Saheb Biswas","project":"Tech-P3"},{"emp_id":"30800017","name":"Rakibul Sk","designation":"Pipe Fitter","con_name":"Saheb Biswas","project":"Tech-P3"},{"emp_id":"31400001","name":"Mithin Miya","designation":"Mason","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400002","name":"Marajul Mia","designation":"Mason","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400003","name":"Nabijon Bibi","designation":"Helper","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400004","name":"Mamta Markam","designation":"Helper","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400005","name":"Nandita Khatun","designation":"Helper","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400006","name":"Oyasim Akram Sarddar","designation":"Contactor","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400007","name":"Saddam Hossain","designation":"Mason","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400008","name":"Masrekul Molla","designation":"Helper","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400009","name":"Mofasil Sardar","designation":"Mason","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400010","name":"Md Kabirul Sk","designation":"Mason","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400011","name":"Randhir Paswan","designation":"Helper","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400012","name":"Sairul Sk","designation":"Helper","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400013","name":"Rakesh Sk","designation":"Mason","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400014","name":"Reja Mondal","designation":"Mason","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400015","name":"Iliyas Sk","designation":"Helper","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31400016","name":"Kanta Markam","designation":"Mason","con_name":"Oyasim Akram Sarddar","project":"Tech-P3"},{"emp_id":"31500001","name":"Mannaf Ali","designation":"Mason","con_name":"Qubic Construction","project":"Tech-P3"},{"emp_id":"31500002","name":"Soker Ali","designation":"Mason","con_name":"Qubic Construction","project":"Tech-P3"},{"emp_id":"31500003","name":"Mohibul Islam","designation":"Mason","con_name":"Qubic Construction","project":"Tech-P3"},{"emp_id":"31500004","name":"Anowar Hussain","designation":"Mason","con_name":"Qubic Construction","project":"Tech-P3"},{"emp_id":"31500005","name":"Mokrom Ali Mollah","designation":"Mason","con_name":"Qubic Construction","project":"Tech-P3"},{"emp_id":"31500006","name":"Sofior Rahman","designation":"Mason","con_name":"Qubic Construction","project":"Tech-P3"},{"emp_id":"22500031","name":"Ishwar Murmu","designation":"Helper","con_name":"M R R Enterprises","project":"LANCO Hills - LH 10"},{"emp_id":"22500079","name":"Budhram Kisku","designation":"Helper","con_name":"M R R Enterprises","project":"LANCO Hills - LH 10"},{"emp_id":"22500192","name":"Aiyub Ali","designation":"Helper","con_name":"M R R Enterprises","project":"LANCO Hills - LH 10"},{"emp_id":"22500235","name":"Nisit Mondal","designation":"Mason","con_name":"M R R Enterprises","project":"LANCO Hills - LH 10"},{"emp_id":"22500308","name":"Rahul Mandal","designation":"Helper","con_name":"M R R Enterprises","project":"LANCO Hills - LH 10"},{"emp_id":"22500338","name":"Baburam Kisku","designation":"Helper","con_name":"M R R Enterprises","project":"LANCO Hills - LH 10"},{"emp_id":"22500347","name":"Jaylen Kisku","designation":"Mason","con_name":"M R R Enterprises","project":"LANCO Hills - LH 10"},{"emp_id":"22500360","name":"Nasim Ali","designation":"Supervisor","con_name":"M R R Enterprises","project":"LANCO Hills - LH 10"},{"emp_id":"3060001","name":"Mallepaka Yadagiri","designation":"Supervisor","con_name":"Rajalaxmi Construction","project":"LANCO Hills - LH 10"},{"emp_id":"3060002","name":"Sikandar","designation":"Mason","con_name":"Rajalaxmi Construction","project":"LANCO Hills - LH 10"},{"emp_id":"3060003","name":"Banarasi","designation":"Mason","con_name":"Rajalaxmi Construction","project":"LANCO Hills - LH 10"},{"emp_id":"3060004","name":"Rampyare","designation":"Mason","con_name":"Rajalaxmi Construction","project":"LANCO Hills - LH 10"},{"emp_id":"3060005","name":"Bhorik","designation":"Mason","con_name":"Rajalaxmi Construction","project":"LANCO Hills - LH 10"},{"emp_id":"3060006","name":"Suraj","designation":"Mason","con_name":"Rajalaxmi Construction","project":"LANCO Hills - LH 10"},{"emp_id":"3060007","name":"Raju","designation":"Mason","con_name":"Rajalaxmi Construction","project":"LANCO Hills - LH 10"},{"emp_id":"3060025","name":"Vallapu Saikumar","designation":"","con_name":"K.Srinu","project":"LANCO Hills - LH 10"},{"emp_id":"3060026","name":"Alakunta Mahesh","designation":"","con_name":"K.Srinu","project":"LANCO Hills - LH 10"},{"emp_id":"3060027","name":"Gogula Shekar","designation":"","con_name":"K.Srinu","project":"LANCO Hills - LH 10"},{"emp_id":"3060028","name":"Dumpa Ramu","designation":"","con_name":"K.Srinu","project":"LANCO Hills - LH 10"},{"emp_id":"3060029","name":"Gogula Veerababu","designation":"","con_name":"K.Srinu","project":"LANCO Hills - LH 10"},{"emp_id":"3060030","name":"Alakunta Venkanna","designation":"","con_name":"K.Srinu","project":"LANCO Hills - LH 10"},{"emp_id":"3060048","name":"Nabakumar Das","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060049","name":"Sukurddin Ali","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060050","name":"Sakir Sk","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060051","name":"Saiful Mondal","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060052","name":"Sahabuddin SK","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060053","name":"Sukuruddin Malitya","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060054","name":"Monoranjon Majhi","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060055","name":"Md. Jalaluddin","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060056","name":"Nur Jamal Mondal","designation":"Contactor","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060057","name":"Jahiruddin Sk","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060058","name":"Amirul Sk","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060059","name":"Raj Sk","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060060","name":"Jahangir Sekh","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060061","name":"Pintu Shekh","designation":"","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060062","name":"Somirul Halsona","designation":"","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060063","name":"Masud Rana Biswas","designation":"","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060064","name":"Md Jiarul Seikh","designation":"","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060065","name":"Mojammel Haque","designation":"Contactor","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060066","name":"Minsarul Hoque","designation":"Mason","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060067","name":"Arjaul Hoque","designation":"Mason","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060068","name":"Abdul","designation":"Helper","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060069","name":"Sk Rintu","designation":"Mason","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060070","name":"Abdul Rokim","designation":"Helper","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060071","name":"Motiur Rahaman","designation":"Helper","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060072","name":"Obaidur Rahaman","designation":"Contactor","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060073","name":"Najme Alam","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060074","name":"Nur Jamal","designation":"Helper","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060075","name":"Jintu","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060076","name":"Aiyub Ali","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060086","name":"Serajul Hoque","designation":"Helper","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060087","name":"Rafikul Alam","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060088","name":"Tahidur Rahaman","designation":"Helper","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060089","name":"Umar Faruk","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060090","name":"Asif Mehebub","designation":"Helper","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060091","name":"Mahidur Rahaman","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060092","name":"Emran Ali","designation":"Supervisor","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060093","name":"Robbul Hoque","designation":"Helper","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060094","name":"Yousuf Ali","designation":"Mason","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060095","name":"Dibeyandu Tanti","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060096","name":"Asraful","designation":"Mason","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060097","name":"Saiful Islam Sekh","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060098","name":"Imran Shaikh","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060099","name":"Aowkat Biswas","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060100","name":"Milon Kabiraj","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060101","name":"Asan Ali SK","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060102","name":"Rekabul","designation":"Mason","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060103","name":"Sabirul Islam","designation":"Helper","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060104","name":"Safikul","designation":"Helper","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060105","name":"Abdul Hasim","designation":"Mason","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060106","name":"Anwarul","designation":"Helper","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060107","name":"Kadir Ali","designation":"Mason","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060108","name":"Bahadur Hossain","designation":"Mason","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060109","name":"Kush Mahammad","designation":"Helper","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060110","name":"Nur Islam","designation":"Helper","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060111","name":"Sariful","designation":"Mason","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060112","name":"Mahidur Hoque","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060113","name":"ABU Taleb","designation":"Mason","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060114","name":"Barkatulla","designation":"Mason","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060115","name":"Ripon Shaikh","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060116","name":"Hafijul Sk","designation":"Supervisor","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060117","name":"Swapan Tanti","designation":"Mason","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060118","name":"Ranjit Tanti","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060119","name":"Jahangir Alam","designation":"Mason","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060120","name":"Gopal Tanti","designation":"Mason","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060121","name":"Suraj Tanti","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060122","name":"Kamrujjaman","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060123","name":"Sariful Hoque","designation":"Mason","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060124","name":"Rahul Amin","designation":"Mason","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060125","name":"Arjaul Hoque","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060126","name":"Rahul Amin","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060127","name":"Abu Kalam","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060139","name":"Mohajjem Miah","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060140","name":"Nasiruddin Miah","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060141","name":"Nur Hossain Mia","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060142","name":"Sahin Alam","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060143","name":"Rashidur Miya","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060144","name":"Asikul Islam","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060145","name":"Md Abu Kalam Ajad","designation":"Helper","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060146","name":"Somirul Sk","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060147","name":"Diluyar Biswas","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060148","name":"Mojammel Sekh","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060149","name":"Tojibar Malitya","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060150","name":"Nurhaque Biswas","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060151","name":"Zurayez Malitya","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060152","name":"Ajijul Hoque","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060153","name":"Minarul Haque","designation":"Mason","con_name":"Mojammel Haque","project":"LANCO Hills - LH 10"},{"emp_id":"3060154","name":"Khalilur Rahaman","designation":"Helper","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060155","name":"Kamal Hossain","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060156","name":"Saifuddin","designation":"Helper","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060157","name":"Md Robiul","designation":"Mason","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060158","name":"Firoj Jamal","designation":"Helper","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060159","name":"Sahajamal Hoque","designation":"Mason","con_name":"Md Imran","project":"LANCO Hills - LH 10"},{"emp_id":"3060160","name":"Jahangir Alam","designation":"Helper","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060161","name":"Sayedul Rahman","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060162","name":"Alep Ali","designation":"Helper","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060163","name":"Hazrat Ali","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060164","name":"Nikatulla","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060165","name":"Hasanujjaman","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060166","name":"Krishna Gopal Karmakar","designation":"Helper","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060167","name":"Saddam Shaikh","designation":"Mason","con_name":"Nur Jamal Mondal","project":"LANCO Hills - LH 10"},{"emp_id":"3060168","name":"Sukul Korwa","designation":"Mason","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"},{"emp_id":"3060169","name":"Amit Korwa","designation":"Helper","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"},{"emp_id":"3060170","name":"Rajendra Kumar","designation":"Mason","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"},{"emp_id":"3060171","name":"Suraman Korwa","designation":"Helper","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"},{"emp_id":"3060172","name":"Ravindra Korwa","designation":"Helper","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"},{"emp_id":"3060173","name":"Sanjay Korwa","designation":"Helper","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"},{"emp_id":"3060174","name":"Sobhan Korwa","designation":"Mason","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"},{"emp_id":"3060175","name":"Suryu Korwa","designation":"Helper","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"},{"emp_id":"3060176","name":"Muklesur Haque","designation":"Mason","con_name":"Obaidur Rahaman","project":"LANCO Hills - LH 10"},{"emp_id":"3060177","name":"Indra Kumar","designation":"Helper","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"},{"emp_id":"3060178","name":"Babulal Singh","designation":"Mason","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"},{"emp_id":"3060179","name":"Virendra Bhuiyan","designation":"Helper","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"},{"emp_id":"3060180","name":"Devendra Bhuiyan","designation":"Mason","con_name":"Dayashankar Prasad","project":"LANCO Hills - LH 10"}];

const NEW_CONTRACTOR_TYPE_2026_08 = {"Masidur Rahaman":"labour_contractor","Oyasim Akram Sarddar":"labour_contractor","Saheb Biswas":"labour_contractor","K.Srinu":"labour_contractor","Md Imran":"labour_contractor","Rukmina Khatoon":"labour_contractor","M R R Enterprises":"company","AVNR":"company","Gayatree":"company","MPIL":"company","C S Water Proofing":"company","Qubic Construction":"company"};

async function nextSubcontractorCode(cid) {
  const r = await query(
    `SELECT COALESCE(MAX(NULLIF(regexp_replace(sc_code,'\\D','','g'),'')::bigint),0) AS mx
     FROM sc_subcontractors WHERE company_id=$1 AND sc_code LIKE 'SC-%'`, [cid]);
  return `SC-${String(Number(r.rows[0].mx) + 1).padStart(3,'0')}`;
}

runSchemaInit('sc-seed-p3-lanco-workers-2026-08', async () => {
  const companyRes = await query(`SELECT id FROM companies LIMIT 1`);
  const companyId = companyRes.rows[0]?.id;
  if (!companyId) { console.error('[seed-sc-workers] no company found'); return; }
  ...
  // Resolve every distinct Con Name to an sc_id once up front — exact/
  // substring match against existing sc_subcontractors first, else create.
  const conNames = [...new Set(SC_WORKERS_2026_08.map(w => w.con_name))];
  const scIdByConName = {};
  for (const conName of conNames) {
    const existing = await query(
      `SELECT id FROM sc_subcontractors WHERE company_id=$1 AND name ILIKE $2 LIMIT 1`,
      [companyId, `%${conName}%`]
    );
    if (existing.rows.length) { scIdByConName[conName] = existing.rows[0].id; continue; }

    const code = await nextSubcontractorCode(companyId);
    const contractorType = NEW_CONTRACTOR_TYPE_2026_08[conName] || 'labour_contractor';
    const created = await query(
      `INSERT INTO sc_subcontractors (company_id, sc_code, name, status, contractor_type, notes)
       VALUES ($1,$2,$3,'active',$4,'Auto-created from P3/LANCO active workers list import')
       RETURNING id`,
      [companyId, code, conName, contractorType]
    );
    scIdByConName[conName] = created.rows[0].id;
    console.log(`[seed-sc-workers] created subcontractor ${code}: ${conName} (${contractorType})`);
  }

  let created = 0, skipped = 0;
  for (const w of SC_WORKERS_2026_08) {
    const scId = scIdByConName[w.con_name] || null;
    const projectId = projByName[w.project.toLowerCase()] || null;

    // Skip if this exact worker (name + contractor) is already logged —
    // keeps this idempotent and avoids double-counting anyone already
    // entered independently through the SC Labour screen.
    const dup = await query(
      `SELECT id FROM sc_workers WHERE company_id=$1 AND sc_id=$2 AND worker_name=$3`,
      [companyId, scId, w.name]
    );
