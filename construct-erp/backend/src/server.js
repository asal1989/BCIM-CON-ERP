...
const hrOnboardingTrainingRoutes = require('./routes/hr-onboarding-training.routes');
...
const hrDocVerificationRoutes = require('./routes/hr-document-verification.routes');
const hrIdCardRoutes      = require('./routes/hr-id-cards.routes');
const hrOffersRoutes      = require('./routes/hr-offers.routes');
...
app.use(`${API}/procurement/bom`, bomRoutes);
...
app.use(`${API}/hr-admin/onboarding/training`, hrOnboardingTrainingRoutes);
...
app.use(`${API}/hr-admin/document-verification`, hrDocVerificationRoutes);
app.use(`${API}/hr-admin/id-cards`, hrIdCardRoutes);
app.use(`${API}/hr-admin/offers`, hrOffersRoutes);
...
if (require.main === module) {
  ...
  server.listen(PORT, () => {
    ...
    const { initMarkAbsent } = require('./utils/hr-mark-absent.service');
    initMarkAbsent();
