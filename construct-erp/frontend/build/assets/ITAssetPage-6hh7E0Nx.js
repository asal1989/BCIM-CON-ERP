import{r as v,j as e,R as ze,a as Oe}from"./vendor-react-QqYhfoRR.js";import{u as je,a as ne,b as se}from"./vendor-data-BlbhaCSi.js";import{Q as ye}from"./index-dd_-JVxX.js";import{u as Qe}from"./vendor-forms-BUMbIR-y.js";import{af as Y,d as We}from"./index-_JX7r2G3.js";import{d as c,c as $,z as j}from"./vendor-ui-CSK4-J8o.js";import{ap as xe,Y as ve,P as de,N as Ne,t as He,f as ue,b as ge,k as Ve,dz as ie,cW as Ge,d6 as Ke,cK as Xe,a8 as Ze,E as we,aL as Je,a$ as es,bT as le,a as ss,R as oe,aj as ts,V as _e,Z as ke,v as as,X as te,bF as rs,cI as ls,z as Se,Q as is,d2 as ns,ar as ds,ad as os,a9 as cs,bf as xs}from"./vendor-icons-g0YxIMGI.js";import{R as ps}from"./RecordAttachments-5eqj_Cu5.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:R=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var X;const L=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((X=R.find(b=>/serial/i.test(b.label||"")))==null?void 0:X.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
