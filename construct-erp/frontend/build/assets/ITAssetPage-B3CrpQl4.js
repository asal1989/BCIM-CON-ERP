import{r as v,j as e,R as ze,k as Oe}from"./vendor-react-Db2HHDvz.js";import{e as je,u as ne,f as se}from"./vendor-data-41-IeaEn.js";import{Q as ye}from"./index-rJwld4ZI.js";import{u as Qe}from"./vendor-forms-CYhUWCSQ.js";import{a8 as Y,p as We}from"./index-xOMJzlB1.js";import{d as c,c as $,z as j}from"./vendor-ui-BbXjBtRR.js";import{aW as xe,aU as ve,f as de,b as Ne,M as He,a4 as ue,ac as ge,a3 as Ve,af as ie,ci as Ge,cj as Ke,ck as Xe,cl as Ze,ax as we,b3 as Je,b4 as es,bV as le,aq as ss,R as oe,V as ts,w as _e,aL as ke,S as as,X as te,bE as rs,cm as ls,aA as Se,a6 as is,cn as ns,aX as ds,aV as os,al as cs,ae as xs}from"./vendor-icons-D-O2V3iZ.js";import{R as ps}from"./RecordAttachments-RFhEJJsS.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var X;const R=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((X=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:X.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
