import{r as v,j as e,R as ze,b as Oe}from"./vendor-react-C3P8e1DV.js";import{f as je,u as ne,g as se}from"./vendor-data-693MZDSQ.js";import{Q as ye}from"./index-fLdOWwHt.js";import{u as Qe}from"./vendor-forms-gVMGBE4b.js";import{af as Y,c as We}from"./index-B7bfrt7D.js";import{d as c,c as $,z as j}from"./vendor-ui-BISbFNDL.js";import{be as xe,D as ve,g as de,c as Ne,a9 as He,as as ue,ao as ge,ap as Ve,aE as ie,cJ as Ge,v as Ke,cK as Je,cL as Xe,aW as we,bq as Ze,bD as es,cg as le,aO as ss,R as oe,o as ts,az as _e,a$ as ke,S as as,X as te,c1 as rs,cx as ls,aY as Se,aw as is,cy as ns,bg as ds,bd as os,aJ as cs,aD as xs}from"./vendor-icons-rcKSwbeQ.js";import{R as ps}from"./RecordAttachments-B_NuY01l.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var J;const R=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((J=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:J.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
`),i=[{label:"Company Name",value:w},{label:"Item Name",value:S},{label:"Serial Number",value:C},{label:"Asset ID",value:y||g}],U=async()=>{var P;if(!g)return;const b=window.open("","_blank","width=620,height=460");if(!b)return;const q=await ms(),z=q?`<img src="${q}" class="logo-img" alt="logo" />`:'<div class="logo-placeholder">BCIM</div>',O=((P=R.current)==null?void 0:P.innerHTML)||"",D=i.filter(Q=>Q.value).map(Q=>`
        <div class="field">
