import{r as v,j as e,R as ze,b as Oe}from"./vendor-react-CcT5oxc9.js";import{f as je,u as ne,g as se}from"./vendor-data-D8jtb2dg.js";import{Q as ye}from"./index-Dzz_yKlZ.js";import{u as Qe}from"./vendor-forms-Dqb3960D.js";import{aj as Y,d as He}from"./index-CS2KkukD.js";import{d as c,c as $,z as j}from"./vendor-ui-CTKQAe7n.js";import{bw as xe,D as ve,Z as de,b3 as Ne,aa as We,ay as ue,at as ge,au as Ve,aM as ie,c$ as Ge,s as Ke,d0 as Xe,bp as Ze,b1 as we,bH as Je,bV as es,cw as le,aV as ss,aI as oe,l as ts,aH as _e,bj as ke,S as as,X as te,cj as rs,cM as ls,b4 as Se,aE as is,cN as ns,by as ds,br as os,af as cs,aK as xs}from"./vendor-icons-BRO_zUiq.js";import{R as ps}from"./RecordAttachments-C99A9iwD.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var X;const R=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((X=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:X.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
