import{r as v,j as e,R as ze,b as Oe}from"./vendor-react-C3P8e1DV.js";import{f as je,u as ne,g as se}from"./vendor-data-693MZDSQ.js";import{Q as ye}from"./index-fLdOWwHt.js";import{u as Qe}from"./vendor-forms-gVMGBE4b.js";import{aj as F,d as He}from"./index-0IUKNmvp.js";import{d as c,c as $,z as j}from"./vendor-ui-BL8pBBi4.js";import{bn as xe,D as ve,Q as de,a_ as Ne,a6 as We,aq as ue,al as ge,am as Ge,aF as ie,cS as Ve,p as Ke,cT as Xe,cU as Ze,aY as we,by as Je,bO as es,cp as le,aQ as ss,az as oe,h as ts,aA as _e,be as ke,S as as,X as te,cc as rs,cF as ls,a$ as Se,aw as is,cG as ns,bp as ds,bl as os,aK as cs,aD as xs}from"./vendor-icons-DitlPXQ2.js";import{R as ps}from"./RecordAttachments-GXK9JSv5.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:Y="ASSET",labelSubtitle:r="Asset Management"}){var X;const R=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((X=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:X.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
