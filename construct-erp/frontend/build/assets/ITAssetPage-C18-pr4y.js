import{r as v,j as e,R as ze,e as Oe}from"./vendor-react-BQzH-qaO.js";import{u as je,a as ne,b as se}from"./vendor-data-q-FEq-2s.js";import{Q as ye}from"./index-D67j1Kc3.js";import{u as Qe}from"./vendor-forms-DVvjmsrU.js";import{ad as Y,d as He}from"./index-BInRcVmn.js";import{d as c,c as $,z as j}from"./vendor-ui-DzxRuvHx.js";import{ap as xe,Y as ve,P as de,N as Ne,s as We,f as ue,b as ge,k as Ve,dz as ie,cW as Ge,d6 as Ke,cJ as Ze,a8 as Je,E as we,aJ as Xe,aZ as es,bQ as le,a as ss,R as oe,aj as ts,V as _e,Z as ke,u as as,h as te,bC as rs,cH as ls,y as Se,Q as is,d2 as ns,ar as ds,ad as os,a9 as cs,bb as xs}from"./vendor-icons-DgS9f7ig.js";import{R as ps}from"./RecordAttachments-bJLMTChr.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:R=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var Z;const L=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((Z=R.find(b=>/serial/i.test(b.label||"")))==null?void 0:Z.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
