import{r as v,j as e,R as ze,a as Qe}from"./vendor-react-QqYhfoRR.js";import{u as je,a as ne,b as se}from"./vendor-data-BlbhaCSi.js";import{Q as ye}from"./index-dd_-JVxX.js";import{u as Oe}from"./vendor-forms-BUMbIR-y.js";import{ad as Y,d as We}from"./index-CXIeBXcj.js";import{d as c,c as $,z as j}from"./vendor-ui-CSK4-J8o.js";import{ap as xe,Y as ve,P as de,N as Ne,t as He,f as ue,b as ge,k as Ve,dy as ie,cV as Ge,d5 as Ke,cJ as Ze,a8 as Je,E as we,aJ as Xe,aZ as es,bQ as le,a as ss,R as oe,aj as ts,V as _e,Z as ke,v as as,X as te,bC as rs,cH as ls,z as Se,Q as is,d1 as ns,ar as ds,ad as os,a9 as cs,bb as xs}from"./vendor-icons-BykIIUYt.js";import{R as ps}from"./RecordAttachments-COXY4fsc.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:C,assetId:u,serialNumber:k,extraFields:R=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var Z;const L=v.useRef(null),y=String(u||C||t||"").trim(),S=String(h||"").trim(),I=String(k||((Z=R.find(b=>/serial/i.test(b.label||"")))==null?void 0:Z.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${I||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
