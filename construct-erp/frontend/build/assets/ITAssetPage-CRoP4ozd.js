import{r as v,j as e,R as ze,b as Oe}from"./vendor-react-C3P8e1DV.js";import{e as je,u as ne,f as se}from"./vendor-data-Bf70pt7o.js";import{Q as ye}from"./index-fLdOWwHt.js";import{u as Qe}from"./vendor-forms-gVMGBE4b.js";import{af as Y,c as We}from"./index-CEmUklin.js";import{d as c,c as $,z as j}from"./vendor-ui-BISbFNDL.js";import{be as xe,D as ve,g as de,c as Ne,a9 as He,as as ue,ao as ge,ap as Ve,aE as ie,cI as Ge,v as Ke,cJ as Je,cK as Xe,aW as we,bp as Ze,bC as es,cf as le,aO as ss,R as oe,o as ts,az as _e,b5 as ke,S as as,X as te,c0 as rs,cw as ls,aY as Se,aw as is,cx as ns,bg as ds,bd as os,aJ as cs,aD as xs}from"./vendor-icons-BHSrRpYB.js";import{R as ps}from"./RecordAttachments-DCGXzEHX.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:R=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var J;const L=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((J=R.find(b=>/serial/i.test(b.label||"")))==null?void 0:J.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
