import{r as v,j as e,R as ze,a as Oe}from"./vendor-react-BAVvCkcf.js";import{f as je,u as ne,g as se}from"./vendor-data-DxqnwYyQ.js";import{Q as ye}from"./index-du6ld7Fj.js";import{u as Qe}from"./vendor-forms-DAwjvItt.js";import{aj as F,d as We}from"./index-Ccl1r6Vc.js";import{d as c,c as $,z as j}from"./vendor-ui-DDtQVt9Z.js";import{bI as xe,D as ve,Z as de,bh as Ne,aa as He,aE as ue,at as ge,au as Ve,b0 as ie,d5 as Ge,s as Ke,d6 as Ze,bB as Xe,aM as we,bR as Je,c3 as es,cD as le,b8 as ss,aZ as oe,l as ts,aF as _e,bv as ke,S as as,X as te,cr as rs,cT as ls,bi as Se,aV as is,aQ as ns,bK as ds,bD as os,af as cs,a_ as xs}from"./vendor-icons-8yK8i0ff.js";import{R as ps}from"./RecordAttachments-W_GiYoHE.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:R=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:Y="ASSET",labelSubtitle:r="Asset Management"}){var Z;const L=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((Z=R.find(b=>/serial/i.test(b.label||"")))==null?void 0:Z.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
