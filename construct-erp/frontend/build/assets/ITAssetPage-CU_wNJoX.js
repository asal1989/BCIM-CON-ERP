<<<<<<<< HEAD:construct-erp/frontend/build/assets/ITAssetPage-CEeWKINw.js
import{r as v,j as e,R as ze,b as Oe}from"./vendor-react-C3P8e1DV.js";import{f as je,u as ne,g as se}from"./vendor-data-693MZDSQ.js";import{Q as ye}from"./index-fLdOWwHt.js";import{u as Qe}from"./vendor-forms-gVMGBE4b.js";import{aj as Y,d as He}from"./index-BvUhTYhL.js";import{d as c,c as $,z as j}from"./vendor-ui-BL8pBBi4.js";import{bC as xe,D as ve,Z as de,b9 as Ne,aa as We,aH as ue,at as ge,au as Ve,aT as ie,d2 as Ge,s as Ke,d3 as Ze,bv as Xe,b7 as we,bL as Je,bZ as es,cz as le,a$ as ss,aQ as oe,l as ts,aP as _e,bp as ke,S as as,X as te,cm as rs,cP as ls,ba as Se,aJ as is,cQ as ns,bE as ds,bx as os,af as cs,aR as xs}from"./vendor-icons-D7aOXlNS.js";import{R as ps}from"./RecordAttachments-Bd-WasNJ.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var Z;const P=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((Z=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:Z.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
========
import{r as v,j as e,R as ze,b as Oe}from"./vendor-react-C3P8e1DV.js";import{f as je,u as ne,g as se}from"./vendor-data-693MZDSQ.js";import{Q as ye}from"./index-fLdOWwHt.js";import{u as Qe}from"./vendor-forms-gVMGBE4b.js";import{aj as Y,d as He}from"./index-DS96Dv3_.js";import{d as c,c as $,z as j}from"./vendor-ui-BL8pBBi4.js";import{bC as xe,D as ve,Z as de,b9 as Ne,aa as We,aH as ue,at as ge,au as Ve,aT as ie,d2 as Ge,s as Ke,d3 as Ze,bv as Xe,b7 as we,bL as Je,bZ as es,cz as le,a$ as ss,aQ as oe,l as ts,aP as _e,bp as ke,S as as,X as te,cm as rs,cP as ls,ba as Se,aJ as is,cQ as ns,bE as ds,bx as os,af as cs,aR as xs}from"./vendor-icons-BKC3oODo.js";import{R as ps}from"./RecordAttachments-BYXz-tOJ.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var Z;const P=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((Z=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:Z.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
>>>>>>>> parent of acc193094 (feat(hr): Document Verification module — Phase 1 (taxonomy, verify/reject queues, audit trail)):construct-erp/frontend/build/assets/ITAssetPage-CU_wNJoX.js
`),i=[{label:"Company Name",value:w},{label:"Item Name",value:S},{label:"Serial Number",value:C},{label:"Asset ID",value:y||g}],U=async()=>{var D;if(!g)return;const b=window.open("","_blank","width=620,height=460");if(!b)return;const B=await ms(),z=B?`<img src="${B}" class="logo-img" alt="logo" />`:'<div class="logo-placeholder">BCIM</div>',O=((D=P.current)==null?void 0:D.innerHTML)||"",R=i.filter(Q=>Q.value).map(Q=>`
        <div class="field">
