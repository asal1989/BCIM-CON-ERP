<<<<<<<< HEAD:construct-erp/frontend/build/assets/ITAssetPage-lOXMxrUp.js
import{r as v,j as e,R as ze,b as Oe}from"./vendor-react-C3P8e1DV.js";import{f as je,u as ne,g as se}from"./vendor-data-693MZDSQ.js";import{Q as ye}from"./index-fLdOWwHt.js";import{u as Qe}from"./vendor-forms-gVMGBE4b.js";import{ah as Y,d as We}from"./index-CcCHka0_.js";import{d as c,c as $,z as j}from"./vendor-ui-BL8pBBi4.js";import{bk as xe,D as ve,K as de,aY as Ne,a3 as He,ao as ue,aj as ge,ak as Ve,aE as ie,cO as Ge,p as Ke,cP as Xe,cQ as Ze,aW as we,bv as Je,bL as es,cl as le,aP as ss,ax as oe,h as ts,ay as _e,bc as ke,S as as,X as te,c7 as rs,cB as ls,aZ as Se,au as is,cC as ns,bm as ds,bj as os,aK as cs,aC as xs}from"./vendor-icons-Bb2wc4Hz.js";import{R as ps}from"./RecordAttachments-CrswoDRy.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var X;const P=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((X=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:X.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
========
import{r as v,j as e,R as ze,b as Oe}from"./vendor-react-C3P8e1DV.js";import{f as je,u as ne,g as se}from"./vendor-data-693MZDSQ.js";import{Q as ye}from"./index-fLdOWwHt.js";import{u as Qe}from"./vendor-forms-gVMGBE4b.js";import{ah as Y,d as We}from"./index-DxxJhgV5.js";import{d as c,c as $,z as j}from"./vendor-ui-BL8pBBi4.js";import{bk as xe,D as ve,K as de,aY as Ne,a3 as He,ao as ue,aj as ge,ak as Ve,aE as ie,cO as Ge,p as Ke,cP as Xe,cQ as Ze,aW as we,bv as Je,bL as es,cl as le,aP as ss,ax as oe,h as ts,ay as _e,bc as ke,S as as,X as te,c7 as rs,cB as ls,aZ as Se,au as is,cC as ns,bm as ds,bj as os,aK as cs,aC as xs}from"./vendor-icons-Bb2wc4Hz.js";import{R as ps}from"./RecordAttachments-D5ptfJSo.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var X;const P=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((X=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:X.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
>>>>>>>> origin/main:construct-erp/frontend/build/assets/ITAssetPage-CoaEkE1b.js
