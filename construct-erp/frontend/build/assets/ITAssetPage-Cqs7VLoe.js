import{r as v,j as e,R as ze,a as Oe}from"./vendor-react-BAVvCkcf.js";import{f as je,u as ne,g as se}from"./vendor-data-DxqnwYyQ.js";import{Q as ye}from"./index-du6ld7Fj.js";import{u as Qe}from"./vendor-forms-DAwjvItt.js";import{aj as Y,d as We}from"./index-DgrW3T11.js";import{d as c,c as $,z as j}from"./vendor-ui-DDtQVt9Z.js";import{bG as xe,D as ve,Z as de,be as Ne,aa as Ge,aB as ue,at as ge,au as He,aZ as ie,d4 as Ve,s as Ke,d5 as Xe,bz as Ze,aG as we,bP as Je,c1 as es,cC as le,b5 as ss,aW as oe,l as ts,aC as _e,bt as ke,S as as,X as te,cp as rs,cS as ls,bf as Se,aR as is,aK as ns,bI as ds,bB as os,af as cs,aX as xs}from"./vendor-icons-AN63dXVW.js";import{R as ps}from"./RecordAttachments-VpgwBCSA.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:C,assetId:u,serialNumber:k,extraFields:R=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var X;const L=v.useRef(null),y=String(u||C||t||"").trim(),S=String(h||"").trim(),I=String(k||((X=R.find(b=>/serial/i.test(b.label||"")))==null?void 0:X.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${I||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
