import{r as v,j as e,R as ze,a as Qe}from"./vendor-react-BAVvCkcf.js";import{f as je,u as ne,g as se}from"./vendor-data-DxqnwYyQ.js";import{Q as ye}from"./index-du6ld7Fj.js";import{u as Oe}from"./vendor-forms-DAwjvItt.js";import{aj as Y,d as We}from"./index-C1ZU9xkB.js";import{d as c,c as $,z as j}from"./vendor-ui-DDtQVt9Z.js";import{bC as xe,D as ve,Z as de,b9 as Ne,aa as He,aG as ue,at as ge,au as Ge,aT as ie,d2 as Ve,s as Ke,d3 as Ze,bv as Xe,b7 as we,bL as Je,bZ as es,cz as le,a$ as ss,aQ as oe,l as ts,aP as _e,bp as ke,S as as,X as te,cm as rs,cP as ls,ba as Se,aM as is,cQ as ns,bE as ds,bx as os,af as cs,aR as xs}from"./vendor-icons-DfVhxm5V.js";import{R as ps}from"./RecordAttachments-Bssj7p8X.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:C,assetId:u,serialNumber:k,extraFields:R=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var Z;const L=v.useRef(null),y=String(u||C||t||"").trim(),S=String(h||"").trim(),I=String(k||((Z=R.find(b=>/serial/i.test(b.label||"")))==null?void 0:Z.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${I||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
...
`)],{type:"text/csv"}),d=URL.createObjectURL(l),o=document.createElement("a");o.href=d,o.download="IT_Assets_Template.csv",document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(d)},Be=async s=>{var d,o,f,q;const l=(d=s.target.files)==null?void 0:d[0];if(l){s.target.value="",S(!0);try{const V=(await l.text()).split(`
`).map(_=>_.trim()).filter(_=>_&&!_.startsWith("#"));if(V.length<2){j.error("No data rows found");return}const H=V[0].split(",").map(_=>_.trim()),be=V.slice(1).map(_=>Object.fromEntries(H.map((Fe,Ue)=>{var he;return[Fe,((he=_.split(",")[Ue])==null?void 0:he.replace(/^"|"$/g,"").trim())||""]}))).filter(_=>_.asset_tag&&_.brand&&_.model);if(!be.length){j.error("No valid rows — need: asset_tag, brand, model");return}const Ye=await Y.import(be);j.success(((o=Ye.data)==null?void 0:o.message)||"Import complete"),a.invalidateQueries({queryKey:["it-assets"]})}catch(ee){j.error(((q=(f=ee.response)==null?void 0:f.data)==null?void 0:q.error)||"Import failed")}finally{S(!1)}}},qe=[{label:"Total Assets",value:A.length,icon:de,color:"text-blue-600",bg:"bg-blue-50"},{label:"In Use",value:$e,icon:Ne,color:"text-green-600",bg:"bg-green-50"},{label:"Available",value:Re,icon:He,color:"text-indigo-600",bg:"bg-indigo-50"},{label:"Warranty Alerts",value:X.length,icon:ue,color:"text-amber-600",bg:"bg-amber-50"},{label:"Antivirus Alerts",value:J.length,icon:ge,color:"text-red-600",bg:"bg-red-50"},{label:"Capital Value",value:`₹${Number(Me).toLocaleString("en-IN",{maximumFractionDigits:0})}`,icon:Ge,color:"text-purple-600",bg:"bg-purple-50"}];return e.jsxs("div",{className:"flex h-full min-h-screen bg-gray-50",children:[e.jsx("style",{children:`
        @media print {
