import{r as v,j as e,R as ze,a as Qe}from"./vendor-react-QqYhfoRR.js";import{u as je,a as ne,b as se}from"./vendor-data-BlbhaCSi.js";import{Q as ye}from"./index-dd_-JVxX.js";import{u as Oe}from"./vendor-forms-BUMbIR-y.js";import{ad as Y,d as We}from"./index-DcgOwZsn.js";import{d as c,c as $,z as j}from"./vendor-ui-CSK4-J8o.js";import{ap as xe,Y as ve,P as de,N as Ne,t as He,f as ue,b as ge,k as Ve,dy as ie,cV as Ge,d5 as Ke,cJ as Ze,a8 as Je,E as we,aJ as Xe,aZ as es,bQ as le,a as ss,R as oe,aj as ts,V as _e,Z as ke,v as as,X as te,bC as rs,cH as ls,z as Se,Q as is,d1 as ns,ar as ds,ad as os,a9 as cs,bb as xs}from"./vendor-icons-BykIIUYt.js";import{R as ps}from"./RecordAttachments-C1HeqrP_.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:C,assetId:u,serialNumber:k,extraFields:R=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var Z;const L=v.useRef(null),y=String(u||C||t||"").trim(),S=String(h||"").trim(),I=String(k||((Z=R.find(b=>/serial/i.test(b.label||"")))==null?void 0:Z.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${I||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
`),i=[{label:"Company Name",value:w},{label:"Item Name",value:S},{label:"Serial Number",value:I},{label:"Asset ID",value:y||g}],U=async()=>{var D;if(!g)return;const b=window.open("","_blank","width=620,height=460");if(!b)return;const B=await ms(),z=B?`<img src="${B}" class="logo-img" alt="logo" />`:'<div class="logo-placeholder">BCIM</div>',Q=((D=L.current)==null?void 0:D.innerHTML)||"",P=i.filter(O=>O.value).map(O=>`
        <div class="field">
          <span class="field-label">${M(O.label)}</span>
          <span class="field-value">${M(O.value)}</span>
...
<body>
  <div class="label">
    <div class="header">
      ...
      <span class="it-badge">${M(F)}</span>
    </div>

    <div class="body">
      <div class="qr-col">
        <div class="qr-box">${Q}</div>
...
</html>`),b.document.close()},V=()=>{var D;const b=(D=L.current)==null?void 0:D.querySelector("svg");if(!b)return;const B=new XMLSerializer().serializeToString(b),z=new Blob([B],{type:"image/svg+xml"}),Q=URL.createObjectURL(z),P=document.createElement("a");P.href=Q,P.download=`${y||g}_QR.svg`,document.body.appendChild(P),P.click(),document.body.removeChild(P),URL.revokeObjectURL(Q)};return g?e.jsxs("div",{className:N,children:[e.jsxs("div",{className:"overflow-hidden rounded-xl border-[2.5px] border-[#0f2d6b] shadow-xl",children:[e.jsxs("div",{className:"flex items-center gap-3 px-4 py-2.5",style:{background:"#0f2d6b"},children:[e.jsxs("div",{className:"h-9 w-9 shrink-0 overflow-hidden rounded-lg bg-white p-1 shadow-sm",children:[e.jsx("img",{src:"/bcim-logo.png",alt:"BCIM",className:"h-full w-full object-contain",onError:b=>{b.target.style.display="none",b.target.nextSibling.style.display="flex"}}),e.jsx("div",{className:"hidden h-full w-full items-center justify-center text-[9px] font-medium text-[#0f2d6b]",children:"BCIM"})]}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("div",{className:"text-[11px] font-medium uppercase tracking-[0.1em] text-white leading-tight",children:w}),e.jsx("div",{className:"text-[9px] font-semibold text-white/70 leading-tight mt-0.5",children:r})]}),e.jsx("div",{className:"shrink-0 rounded bg-white px-2.5 py-1 text-[9px] font-medium uppercase tracking-widest text-[#0f2d6b]",children:F})]}),e.jsxs("div",{className:"flex items-stretch bg-white",children:[e.jsxs("div",{className:"flex flex-col items-center justify-center gap-2 border-r-2 border-dashed border-blue-200 bg-[#eef2ff] px-5 py-4 shrink-0",children:[e.jsx("div",{className:"rounded-lg bg-white p-2.5 shadow-md ring-2 ring-[#0f2d6b]/20",children:e.jsx("div",{ref:L,children:e.jsx(ye,{value:a,size:E,includeMargin:!1,fgColor:"#0f2d6b",level:"M"})})}),e.jsx("p",{className:"text-[9px] font-medium uppercase tracking-[0.15em] text-gray-600",children:"Scan to identify"})]}),e.jsxs("div",{className:"flex flex-1 flex-col justify-center gap-1.5 px-5 py-4",children:[e.jsx("div",{className:"font-mono text-2xl font-medium leading-none tracking-wide text-[#0f2d6b]",children:y||g}),e.jsx("div",{className:"text-sm font-medium text-gray-900",children:S}),n&&e.jsx("div",{className:"text-[10px] font-bold uppercase tracking-widest text-gray-600",children:n}),e.jsx("div",{className:"my-1 border-t-2 border-gray-200"}),e.jsx("div",{className:"space-y-1.5",children:i.filter(b=>b.value).map((b,B)=>e.jsxs("div",{className:"flex items-baseline gap-2",children:[e.jsx("span",{className:"min-w-[92px] text-[9px] font-medium uppercase tracking-wider text-gray-500",children:b.label}),e.jsx("span",{className:"text-[11px] font-bold text-gray-900",children:b.value})]},B))})]})]}),e.jsxs("div",{className:"flex items-center justify-between px-4 py-1.5",style:{background:"#0f2d6b"},children:[e.jsx("span",{className:"text-[9px] font-bold text-white/80 tracking-wide",children:"Scan QR to view full asset details"}),e.jsxs("span",{className:"text-[8.5px] font-semibold text-white/60",children:["Property of ",w]})]})]}),e.jsxs("div",{className:"mt-3 flex gap-2",children:[e.jsxs("button",{type:"button",onClick:U,className:"flex flex-1 items-center justify-center gap-2 rounded-lg py-2.5 text-sm font-bold text-white transition hover:opacity-90",style:{background:"#0f2d6b"},children:[e.jsx(xe,{className:"h-4 w-4"}),"Print Label"]}),e.jsxs("button",{type:"button",onClick:V,title:"Download QR as SVG",className:"flex items-center justify-center gap-2 rounded-lg border-2 border-[#0f2d6b] bg-white px-4 py-2.5 text-sm font-bold text-[#0f2d6b] transition hover:bg-blue-50",children:[e.jsx(ve,{className:"h-4 w-4"}),"QR"]})]})]}):null}const ce=[{key:"all",label:"All Assets",Icon:de,color:"#1a73e8"},{key:"laptop",label:"Laptops",Icon:Ge,color:"#1a73e8"},{key:"desktop",label:"Desktops",Icon:Ke,color:"#1a73e8"},{key:"server",label:"Servers",Icon:Ze,color:"#6c35de"},{key:"network",label:"Network",Icon:Je,color:"#0f9d58"},{key:"cctv",label:"CCTV",Icon:we,color:"#f4a100"},{key:"biometric",label:"Biometric",Icon:Xe,color:"#f4a100"},{key:"printer",label:"Printers",Icon:xe,color:"#5f6368"},{key:"ups",label:"UPS",Icon:es,color:"#d93025"},{key:"other",label:"Others",Icon:le,color:"#5f6368"}],fe=[{key:"all",label:"All Status",dot:"#9aa0a6"},{key:"in_use",label:"In Use",dot:"#0f9d58"},{key:"available",label:"Available",dot:"#1a73e8"},{key:"under_repair",label:"Under Repair",dot:"#f4a100"},{key:"retired",label:"Retired",dot:"#9aa0a6"},{key:"lost",label:"Lost / Stolen",dot:"#d93025"}],ae={in_use:"bg-green-50 text-green-700 border border-green-200",available:"bg-blue-50 text-blue-700 border border-blue-200",under_repair:"bg-yellow-50 text-yellow-700 border border-yellow-200",retired:"bg-gray-100 text-slate-600 border border-gray-200",lost:"bg-red-50 text-red-700 border border-red-200"},re={in_use:"In Use",available:"Available",under_repair:"Under Repair",retired:"Retired",lost:"Lost/Stolen"},K=Object.fromEntries(ce.slice(1).map(t=>[t.key,t])),x="w-full rounded border border-gray-200 bg-white px-3 py-2 text-sm text-black outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-100 transition",hs={laptop:"LT",desktop:"DT",server:"SRV",network:"NET",cctv:"CCTV",biometric:"BIO",printer:"PRN",ups:"UPS",other:"OTH"};function us(t,h="other"){const n=String(t||"").trim().toUpperCase().replace(/\s+/g,"-");if(!n||n.startsWith("BCIM-IT-"))return n;if(n.startsWith("BCIM-"))return`BCIM-IT-${n.slice(5).replace(/^IT-/,"")}`;if(n.startsWith("IT-"))return`BCIM-${n}`;const m=hs[String(h||"").toLowerCase()]||"OTH";return n.startsWith(`${m}-`)||n.startsWith(m)?`BCIM-IT-${n}`:`BCIM-IT-${m}-${n}`}function p({label:t,children:h,span:n=1}){return e.jsxs("div",{className:$("space-y-1",n===2&&"col-span-2",n===3&&"col-span-3"),children:[e.jsx("label",{className:"block text-xs font-medium text-gray-500",children:t}),h]})}function Ae(t){return`${t.brand||""} ${t.model||""}`.trim()||t.asset_tag||"-"}function gs(t){return["Company: BCIM Engineering Pvt Ltd",`Item: ${Ae(t)}`,`Serial: ${t.serial_number||"-"}`,`Asset ID: ${t.asset_tag||"-"}`].join(`
`)}function Cs(){const[t,h]=v.useState(!1),[n,m]=v.useState(null),[C,u]=v.useState(null),[k,R]=v.useState(null),[N,E]=v.useState("all"),[w,F]=v.useState("all"),[r,L]=v.useState(""),[y,S]=v.useState(!1),[I,g]=v.useState(()=>new Set),a=je(),{register:i,handleSubmit:U,reset:V,setValue:Z}=Oe(),b=ze.useRef(null),{data:B,isLoading:z,refetch:Q}=ne({queryKey:["it-assets"],queryFn:()=>Y.list().then(s=>{var l;return(l=s.data)==null?void 0:l.data}).catch(()=>[])}),{data:P=[]}=ne({queryKey:["projects-list"],queryFn:()=>We.list().then(s=>{var l;return((l=s.data)==null?void 0:l.data)||s.data||[]}).catch(()=>[])}),D=se({mutationFn:s=>n?Y.update(n.id,s):Y.create(s),onSuccess:()=>{j.success(n?"Asset updated":"Asset registered"),V(),h(!1),m(null),a.invalidateQueries({queryKey:["it-assets"]})},onError:s=>{var l,d;return j.error(((d=(l=s==null?void 0:s.response)==null?void 0:l.data)==null?void 0:d.error)||"Save failed")}}),O=se({mutationFn:s=>Y.delete(s),onSuccess:()=>{j.success("Asset deleted"),a.invalidateQueries({queryKey:["it-assets"]})},onError:s=>{var l,d;return j.error(((d=(l=s==null?void 0:s.response)==null?void 0:l.data)==null?void 0:d.error)||"Delete failed")}}),A=B||[],T=A.filter(s=>!(N!=="all"&&s.asset_type!==N||w!=="all"&&s.status!==w||r&&!`${s.asset_tag} ${s.brand} ${s.model} ${s.serial_number||""} ${s.location_description||""}`.toLowerCase().includes(r.toLowerCase()))),W=v.useMemo(()=>T.filter(s=>I.has(s.id)),[T,I]),pe=T.length>0&&T.every(s=>I.has(s.id)),Ce=s=>{g(l=>{const d=new Set(l);return d.has(s)?d.delete(s):d.add(s),d})},Ie=()=>{g(s=>{const l=new Set(s);return pe?T.forEach(d=>l.delete(d.id)):T.forEach(d=>l.add(d.id)),l})},Te=()=>{if(!W.length){j.error("Select IT assets to print QR labels");return}setTimeout(()=>window.print(),80)},J=A.filter(s=>{const l=s.warranty_expiry?c(s.warranty_expiry).diff(c(),"day"):null;return l!==null&&l>=0&&l<=90}),X=A.filter(s=>s.antivirus_expiry?c(s.antivirus_expiry).diff(c(),"day")<=30:!1),Me=A.reduce((s,l)=>s+parseFloat(l.purchase_cost||0),0),$e=A.filter(s=>s.status==="in_use").length,Re=A.filter(s=>s.status==="available").length,Le=()=>{m(null),V({status:"available",asset_type:"laptop",asset_tag:"BCIM-IT-LT-"}),h(!0)},Pe=s=>{m(s),Object.entries(s).forEach(([l,d])=>Z(l,d??"")),h(!0)},me=()=>{V(),h(!1),m(null)},De=()=>{const s=["asset_tag","asset_type","brand","model","serial_number","os","processor","ram_gb","storage_gb","ip_address","mac_address","status","assigned_to_name","location_description","purchase_date","purchase_cost","warranty_expiry","antivirus_status","antivirus_expiry","project_name","notes"],l=s.join(","),d=A.map(ee=>s.map(G=>{const H=ee[G]??"";return typeof H=="string"&&H.includes(",")?`"${H}"`:H}).join(",")),o=new Blob([l+`
`+d.join(`
`)],{type:"text/csv"}),f=URL.createObjectURL(o),q=document.createElement("a");q.href=f,q.download=`IT_Assets_${c().format("YYYY-MM-DD")}.csv`,document.body.appendChild(q),q.click(),document.body.removeChild(q),URL.revokeObjectURL(f),j.success(`Exported ${A.length} assets`)},Ee=()=>{const s=["asset_tag,asset_type,brand,model,serial_number,os,purchase_date,purchase_cost,warranty_expiry,status,location_description,notes","BCIM-IT-LT-001,laptop,Dell,Latitude 5540,SN1234567,Windows 11 Pro,2024-01-15,85000,2027-01-15,in_use,HO - Accounts Dept,Assigned to finance team","# asset_type: laptop | desktop | server | network | cctv | biometric | printer | ups | other","# status: in_use | available | under_repair | retired | lost"],l=new Blob([s.join(`
`)],{type:"text/csv"}),d=URL.createObjectURL(l),o=document.createElement("a");o.href=d,o.download="IT_Assets_Template.csv",document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(d)},Be=async s=>{var d,o,f,q;const l=(d=s.target.files)==null?void 0:d[0];if(l){s.target.value="",S(!0);try{const G=(await l.text()).split(`
`).map(_=>_.trim()).filter(_=>_&&!_.startsWith("#"));if(G.length<2){j.error("No data rows found");return}const H=G[0].split(",").map(_=>_.trim()),be=G.slice(1).map(_=>Object.fromEntries(H.map((Fe,Ue)=>{var he;return[Fe,((he=_.split(",")[Ue])==null?void 0:he.replace(/^"|"$/g,"").trim())||""]}))).filter(_=>_.asset_tag&&_.brand&&_.model);if(!be.length){j.error("No valid rows — need: asset_tag, brand, model");return}const Ye=await Y.import(be);j.success(((o=Ye.data)==null?void 0:o.message)||"Import complete"),a.invalidateQueries({queryKey:["it-assets"]})}catch(ee){j.error(((q=(f=ee.response)==null?void 0:f.data)==null?void 0:q.error)||"Import failed")}finally{S(!1)}}},qe=[{label:"Total Assets",value:A.length,icon:de,color:"text-blue-600",bg:"bg-blue-50"},{label:"In Use",value:$e,icon:Ne,color:"text-green-600",bg:"bg-green-50"},{label:"Available",value:Re,icon:He,color:"text-indigo-600",bg:"bg-indigo-50"},{label:"Warranty Alerts",value:J.length,icon:ue,color:"text-amber-600",bg:"bg-amber-50"},{label:"Antivirus Alerts",value:X.length,icon:ge,color:"text-red-600",bg:"bg-red-50"},{label:"Capital Value",value:`₹${Number(Me).toLocaleString("en-IN",{maximumFractionDigits:0})}`,icon:Ve,color:"text-purple-600",bg:"bg-purple-50"}];return e.jsxs("div",{className:"flex h-full min-h-screen bg-gray-50",children:[e.jsx("style",{children:`
        @media print {
