import{r as v,j as e,R as ze,a as Qe}from"./vendor-react-BAVvCkcf.js";import{f as je,u as ne,g as se}from"./vendor-data-DxqnwYyQ.js";import{Q as ye}from"./index-du6ld7Fj.js";import{u as Oe}from"./vendor-forms-DAwjvItt.js";import{aj as Y,d as We}from"./index-BQ_6t_Hh.js";import{d as c,c as $,z as j}from"./vendor-ui-DDtQVt9Z.js";import{bC as xe,D as ve,Z as de,b9 as Ne,aa as He,aB as ue,at as ge,au as Ve,aT as ie,d2 as Ge,s as Ke,d3 as Ze,bv as Xe,b7 as we,bL as Je,bZ as es,cz as le,a$ as ss,aQ as oe,l as ts,aC as _e,bp as ke,S as as,X as te,cm as rs,cP as ls,ba as Se,aL as is,cQ as ns,bE as ds,bx as os,af as cs,aR as xs}from"./vendor-icons-CXK5zR4k.js";import{R as ps}from"./RecordAttachments-DAbD_rst.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:C,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var Z;const R=v.useRef(null),y=String(u||C||t||"").trim(),S=String(h||"").trim(),I=String(k||((Z=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:Z.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${I||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
`),i=[{label:"Company Name",value:w},{label:"Item Name",value:S},{label:"Serial Number",value:I},{label:"Asset ID",value:y||g}],U=async()=>{var D;if(!g)return;const b=window.open("","_blank","width=620,height=460");if(!b)return;const B=await ms(),z=B?`<img src="${B}" class="logo-img" alt="logo" />`:'<div class="logo-placeholder">BCIM</div>',Q=((D=R.current)==null?void 0:D.innerHTML)||"",P=i.filter(O=>O.value).map(O=>`
        <div class="field">
