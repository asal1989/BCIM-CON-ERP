import{r as v,j as e,R as ze,b as Oe}from"./vendor-react-C3P8e1DV.js";import{e as je,u as ne,f as se}from"./vendor-data-Bf70pt7o.js";import{Q as ye}from"./index-fLdOWwHt.js";import{u as Qe}from"./vendor-forms-gVMGBE4b.js";import{af as Y,c as He}from"./index-BaxQz0CP.js";import{d as c,c as $,z as j}from"./vendor-ui-BISbFNDL.js";import{b4 as xe,D as ve,g as oe,c as Ne,_ as We,ah as ue,ad as ge,ae as Ve,at as ie,cz as Ge,cA as Ke,cB as Xe,cC as Ze,aL as we,bf as Je,bs as es,c5 as le,aD as ss,R as de,o as ts,ao as _e,aX as ke,S as as,X as te,bS as rs,cm as ls,aN as Se,al as is,co as ns,b6 as os,b3 as ds,ay as cs,as as xs}from"./vendor-icons-DFR8gyas.js";import{R as ps}from"./RecordAttachments-C1OsodXJ.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var X;const R=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((X=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:X.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
