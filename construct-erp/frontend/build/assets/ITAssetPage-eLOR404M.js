import{r as v,j as e,R as ze,b as Oe}from"./vendor-react-C3P8e1DV.js";import{e as je,u as ne,f as se}from"./vendor-data-Bf70pt7o.js";import{Q as ye}from"./index-fLdOWwHt.js";import{u as Qe}from"./vendor-forms-gVMGBE4b.js";import{af as F,c as He}from"./index-BZQyQYZV.js";import{d as c,c as $,z as j}from"./vendor-ui-BISbFNDL.js";import{bb as xe,D as ve,g as de,c as Ne,a6 as We,ap as ue,al as ge,am as Ge,aB as ie,cF as Ve,v as Ke,cG as Xe,cH as Ze,aT as we,bm as Je,bz as es,cc as le,aL as ss,R as oe,o as ts,aw as _e,b2 as ke,S as as,X as te,bZ as rs,ct as ls,aV as Se,at as is,cu as ns,bd as ds,ba as os,aG as cs,aA as xs}from"./vendor-icons-CnZeKCJZ.js";import{R as ps}from"./RecordAttachments-DBPABch0.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:Y="ASSET",labelSubtitle:r="Asset Management"}){var X;const R=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((X=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:X.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
