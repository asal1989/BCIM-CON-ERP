import{r as v,j as e,R as ze,k as Oe}from"./vendor-react-Db2HHDvz.js";import{e as je,u as ne,f as se}from"./vendor-data-41-IeaEn.js";import{Q as ye}from"./index-rJwld4ZI.js";import{u as Qe}from"./vendor-forms-CYhUWCSQ.js";import{aa as Y,p as We}from"./index-C8rArr2J.js";import{d as c,c as $,z as j}from"./vendor-ui-CyPmblEP.js";import{aW as xe,aU as ve,g as de,c as Ne,z as He,a4 as ue,a1 as ge,a2 as Ve,ah as ie,co as Ge,cp as Ke,cq as Xe,cr as Je,ax as we,b4 as Ze,b5 as es,b$ as le,aq as ss,R as oe,J as ts,ab as _e,aL as ke,S as as,X as te,bL as rs,cs as ls,aA as Se,a8 as is,ct as ns,aX as ds,aV as os,am as cs,ag as xs}from"./vendor-icons-Dkh30ToK.js";import{R as ps}from"./RecordAttachments-Ca8SMRsM.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:L=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var X;const R=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((X=L.find(b=>/serial/i.test(b.label||"")))==null?void 0:X.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
`),i=[{label:"Company Name",value:w},{label:"Item Name",value:S},{label:"Serial Number",value:C},{label:"Asset ID",value:y||g}],U=async()=>{var D;if(!g)return;const b=window.open("","_blank","width=620,height=460");if(!b)return;const q=await ms(),z=q?`<img src="${q}" class="logo-img" alt="logo" />`:'<div class="logo-placeholder">BCIM</div>',O=((D=R.current)==null?void 0:D.innerHTML)||"",P=i.filter(Q=>Q.value).map(Q=>`
        <div class="field">
