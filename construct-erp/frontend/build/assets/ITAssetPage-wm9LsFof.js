import{r as v,j as e,R as ze,a as Oe}from"./vendor-react-BAVvCkcf.js";import{f as je,u as ne,g as se}from"./vendor-data-DxqnwYyQ.js";import{Q as ye}from"./index-du6ld7Fj.js";import{u as Qe}from"./vendor-forms-DAwjvItt.js";import{aj as Y,d as We}from"./index-CpiUbymX.js";import{d as c,c as $,z as j}from"./vendor-ui-DDtQVt9Z.js";import{bH as xe,D as ve,Z as de,bg as Ne,aa as He,aB as ue,at as ge,au as Ve,a$ as ie,d4 as Ge,s as Ke,d5 as Ze,bA as Je,aJ as we,bQ as Xe,c2 as es,cC as le,b7 as ss,aY as oe,l as ts,aC as _e,bu as ke,S as as,X as te,cq as rs,cS as ls,bh as Se,aT as is,aN as ns,bJ as ds,bC as os,af as cs,aZ as xs}from"./vendor-icons-Cdw678LO.js";import{R as ps}from"./RecordAttachments-30xH3_Zd.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:C,assetId:u,serialNumber:k,extraFields:R=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var Z;const L=v.useRef(null),y=String(u||C||t||"").trim(),S=String(h||"").trim(),I=String(k||((Z=R.find(b=>/serial/i.test(b.label||"")))==null?void 0:Z.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${I||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
