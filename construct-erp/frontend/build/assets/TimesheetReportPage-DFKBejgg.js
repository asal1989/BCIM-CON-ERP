import{r as l,j as t}from"./vendor-react-C3P8e1DV.js";import{u as I}from"./vendor-data-693MZDSQ.js";import{aP as O,c as H}from"./index-DNLnJhPU.js";import{bl as M,R as U,D as $,bk as K}from"./vendor-icons-DyaDStSp.js";import"./vendor-ui-BISbFNDL.js";import"./vendor-forms-gVMGBE4b.js";const V=()=>new Date().toISOString().slice(0,10),E=d=>new Date(d+"T00:00:00").toLocaleDateString("en-IN",{weekday:"long",day:"2-digit",month:"long",year:"numeric"}),C={present:{bg:"#D1FAE5",color:"#065F46"},absent:{bg:"#FEE2E2",color:"#991B1B"},leave:{bg:"#FEF3C7",color:"#92400E"},half_day:{bg:"#DBEAFE",color:"#1E40AF"},holiday:{bg:"#EDE9FE",color:"#5B21B6"}},Y={present:"P",absent:"A",leave:"L",half_day:"HD",holiday:"H"};function q({status:d}){const m=(d||"absent").toLowerCase(),{bg:p,color:h}=C[m]||C.absent;return t.jsx("span",{style:{background:p,color:h,border:`1px solid ${h}33`,borderRadius:3,padding:"1px 7px",fontWeight:700,fontSize:10,letterSpacing:.5,display:"inline-block"},children:Y[m]||m.toUpperCase()})}const w={"EMP ID":"emp_id",Name:"name",Designation:"designation",Department:"department",Company:"company","P/A":"attendance_status","In Time":"in_time","Out Time":"out_time","Late\nMin":"late_minutes",Shift:"shift",Location:"location","Emp Status":"status",Reason:"reason"},G=`
@media print {
