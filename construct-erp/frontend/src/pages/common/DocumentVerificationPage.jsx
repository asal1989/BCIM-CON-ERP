...
const DOC_TYPES = {
  ...
  'payment-cert':{ label: 'Vendor Bill Payment Certificate', endpoint: '/tqs/bills/public/verify',          numberField: 'sl_number',       dateField: 'inv_date',    vendorField: 'vendor_name',      projectField: 'project_name', statusApproved: ['approved','paid','part_paid'] },
