...
const DOC_TYPES = {
  ...
  ign:          { label: 'Inward Goods Note',            endpoint: '/ign/public/verify',                numberField: 'ign_number',      dateField: 'date_time',   vendorField: 'supplier_name',    projectField: 'project_name', statusApproved: ['inspected','approved'] },
