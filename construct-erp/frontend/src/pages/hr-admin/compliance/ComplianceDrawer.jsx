...
import {
  X, FileText, Paperclip, Send, ShieldCheck, Scale, Users2,
          ...
          <motion.aside
            ...
            <div className="px-6 py-5 border-b border-slate-100 flex items-start justify-between gap-3"
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  {item.readOnly && (
                    <span className="text-[11px] px-2 py-0.5 rounded-full font-semibold bg-slate-100 text-slate-500">
                      Synced from {item.sourcePage}
                    </span>
                  )}
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-4">
              ...
              <Section icon={Paperclip} title="Documents & Attachments">
                {item.documents > 0 ? (
                  <div className="flex items-center gap-2.5 bg-white rounded-xl border border-slate-100 px-3 py-2.5">
