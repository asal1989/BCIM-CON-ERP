  ...
  return (
    <div className="p-4">
      ...
      <div id="report-print-root">
        <ReportPrintHeader reportTitle="Attendance Summary Report" subtitle={`${from} to ${to}`} />
        {isLoading ? (
          <div className="no-print" style={{ textAlign:'center', padding:'60px', color:'#94A3B8' }}>Loading...</div>
        ) : rows.length === 0 ? (
          <div className="no-print" style={{ textAlign:'center', padding:'60px', color:'#94A3B8', background:'#fff', borderRadius:8, border:'1px solid #E2E8F0' }}>
