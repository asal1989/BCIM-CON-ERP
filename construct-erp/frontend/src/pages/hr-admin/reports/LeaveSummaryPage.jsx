...
import { Download, CalendarOff, Printer } from 'lucide-react';
  ...
  return (
    <div className="p-4">
      ...
      <div id="report-print-root">
        <ReportPrintHeader reportTitle="Leave Summary" subtitle={`Year ${year}`} />
        ...
        {isLoading ? (
          ...
          <div className="no-print" style={{ textAlign:'center', padding:'40px', color:'#94A3B8' }}>No leave data found</div>
        ) : (
