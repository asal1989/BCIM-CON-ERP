        ...
        <tbody>
          ...
          <tr>
            <td style={{ ...cell(), fontWeight: 'bold' }}>
              Proforma No: <span style={{ fontWeight: 'normal' }}>{proformaNo || '—'}</span>
            </td>
            <td style={{ ...cell(), fontWeight: 'bold' }}>
          ...
          <tr>
            <td style={{ ...cell(), fontWeight: 'bold' }}>
              Date: <span style={{ fontWeight: 'normal' }}>{proformaDate ? new Date(proformaDate).toLocaleDateString('en-GB').replace(/\//g, '.') : '—'}</span>
            </td>
            <td style={{ ...cell(), fontWeight: 'bold' }}>
...
RABillProformaInvoice.displayName = 'RABillProformaInvoice';
export default RABillProformaInvoice;
